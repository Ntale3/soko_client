...
const ROLE_OPTIONS: RoleOption[] = [
  { value: "farmer", title: "Sell My Produce",    description: "I grow crops and want to reach buyers directly",    icon: "🌾" },
  { value: "buyer",  title: "Buy From Farmers",   description: "I want to source fresh produce directly from farms", icon: "🛒" },
  { value: "both",   title: "Both",               description: "I want to buy and sell on one account",             icon: "🤝" },
]

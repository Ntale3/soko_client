...
export const panel = (
  <div>
    {/* Heading */}
    <h2 className="fraunces text-[36px] font-extrabold leading-[1.1] tracking-[-0.3px] text-white mb-4">
      Your farm market,
      <br />
    ...
    <p className="text-sm leading-[1.8] mb-8" style={{ color: "rgba(255,255,255,.5)" }}>
      Sign back in to check today's prices, manage your listings, and chat with farmers across
      Uganda.
    </p>

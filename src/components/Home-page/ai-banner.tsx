  ...
  return (
    <div className="rounded-3xl overflow-hidden bg-linear-to-br from-primary via-muted-600 to-card p-5 shadow-2xl relative">
      ...
      <div className="relative z-10">
        ...
        {/* Heading */}
        <h2 className="text-foreground text-lg  font-bold leading-tight mb-1 font-serif">
          Avocado prices rising 37% in 2 weeks
        </h2>

        {/* Description */}
        <p className="text-foreground/60 text-xs mb-4">Based on market data & seasonal trends</p>
